...
const Card = ({
	...
	return (
		<Link
			...
			className={clsx("max-w-xl hover:backdrop-blur-[2px] flex flex-col sm:flex-row gap-9 items-start card cursor-pointer p-5 rounded-md border-[1px] group border-transparent hover:bg-white/[.02] hover:border-[#303030] transition-all ease-out duration-150", className)}
		>
			{image && (
				<div
					className={clsx(
